...
from pypokerai.value_function import LinearModelBinaryOnehotFeaturesValueFunction, action_index
...
TRAINING_TITLE = "binary_feature_deep_q_learning_trash_%s" % time_stamp
...
task = TexasHoldemTask(final_round=1, scale_reward=True, lose_penalty=True, shuffle_position=True)
