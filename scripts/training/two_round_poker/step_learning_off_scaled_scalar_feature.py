...
TRAINING_TITLE = "step_learning_off_scaled_scalar_feature_%s" % time_stamp
...
task = TexasHoldemTask(final_round=2, scale_reward=True, lose_penalty=True)
...
LOAD_DIR_NAME = "step_learning_2_round_scaled_scalar_feature_result"
LOAD_DIR_PATH = os.path.join(os.path.dirname(__file__), LOAD_DIR_NAME)
